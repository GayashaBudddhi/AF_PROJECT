...
class AttendeeWorkShopPayment extends Component {
    ...
    onSubmit(e) {
        ...
        console.log('data to send', workshoppayments);
        axios.post('http://localhost:8081/workshoppayments/create', workshoppayments )
            .then(response => {
        ...
        return (
            <div className="container">
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="mb-3">
                        <label htmlFor="workShop" className="form-label">Research Proposal</label>
                        <Select
